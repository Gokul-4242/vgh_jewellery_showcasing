...
export class CollectionsComponent {
  @Input() title: string = 'Our Jewellery Collections';
  @Input() collections: Collection[] = [
    {
      title: 'Gold Collection',
      description: 'Handcrafted gold jewellery with certified purity and custom design options.',
      ...
      linkText: 'Explore Gold Designs',
      link: '/gold-collection'
    },
    {
      title: 'Silver Collection',
      description: 'Elegant silver jewellery designed for everyday wear and special occasions.',
      ...
      linkText: 'Explore Silver Designs',
